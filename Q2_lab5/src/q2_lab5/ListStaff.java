...
public class ListStaff extends ArrayList<Staff> {
    ...
    public void addLecture() {
        ...
        lec.Input();
        this.add(lec);
        savaToFile("C:\\CSE_203\\lab5\\EiuStaff.eiu.txt");
    }
    ...
    public void addTeachingAssitant() {
        Staff ta = new teaching_Assistants();
        try {
            ta.Input();
        } catch (InputMismatchException e) {
    ...
    public void salaryByType(String fName) {
        ...
        try {
            ...
            double totalSpe = 0;
            for (Staff st : this) {
                if (st.getClass().toString().compareTo("class q2_lab5.Lecturers") == 0) {
                    totalLec += st.salary;
                } else if (st.getClass().toString().compareTo("class q2_lab5.teaching_Assistants")==0) {
                    totalAssi += st.salary;
                } else if ((st.getClass().toString().compareTo("class q2_lab5.Researchers")==0)) {
                    totalRe += st.salary;
                } else if ((st.getClass().toString().compareTo("class q2_lab5.Specialists")==0)){
                    totalSpe += st.salary;
                }
            }
