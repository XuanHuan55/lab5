...
public class Student implements Serializable {
    ...
    public static Comparator<Student> compareClass = new Comparator<Student>() {
        ...
        public int compare(Student a, Student b) {
            if (a.getClass().toString().compareTo("class q1_lab5.College_Students") == 0 && b.getClass().toString().compareTo("class cse203.assignment3.UniversityStu") == 0) {
                return -1;
            } else if (a.getClass().toString().compareTo("class q1_lab5.University_Students") == 0 && b.getClass().toString().compareTo("class cse203.assignment3.CollegeStudent") == 0) {
                return 1;
            } else {
